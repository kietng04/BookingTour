...
const TourItinerary = ({ itinerary }) => (
  <Card className="space-y-6">
    <h3 className="text-lg font-semibold text-slate-900">Signature itinerary</h3>
    <div className="space-y-5">
      {itinerary.map((day) => (
        <div key={day.day} className="rounded-2xl border border-slate-100 bg-slate-50/60 p-5">
          <p className="text-sm font-semibold uppercase tracking-widest text-primary-500">Day {day.day}</p>
